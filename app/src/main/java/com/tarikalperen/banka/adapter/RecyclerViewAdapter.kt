package com.tarikalperen.banka.adapter
...
import com.tarikalperen.banka.R
...
class RecyclerViewAdapter(private val cryptoList : ArrayList<CrytoModel>, private val listener : Listener) : RecyclerView.Adapter<RecyclerViewAdapter.RowHolder>() {
